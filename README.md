...
- **NEW: Ask Google's Gemini AI a spoken question using an instance of the Chrome browser. Will open a browser if no active instance found. Only the transcribed text is sent online.**
